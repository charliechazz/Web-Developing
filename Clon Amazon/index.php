...
<a name="arriba"></a>
    ...
    <?php
     if(isset($_GET["enviar"])){
        header("Location:busquedaarticulo.php");
     }
    ?>
...
<h2>OFERTAS DEL DIA</h2>
    <div align="center" class="contcards">
            <div class="itemcard">
                <br>
                    <?php
                        $busqueda = "laptop";
