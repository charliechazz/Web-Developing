...
<div class="container"><br><img class="mx-auto d-block" src="logo2.png" width="160px" height="30px"></div>
    ...
    <div class="container p-3 mt-3 my-3"  style="width: 400px;">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title titulo">Elimina tu cuenta</h1>
                    <div class="w-30">
                        <form id="registro" method="POST" action="eliminar_re.php" autocomplete="off">

                            <br><label class="form-label relleno">Número de celular</label>
